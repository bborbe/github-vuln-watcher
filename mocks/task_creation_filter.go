...
type TaskCreationFilter struct {
	SkipStub        func(filter.Candidate) string
	skipMutex       sync.RWMutex
	skipArgsForCall []struct {
		arg1 filter.Candidate
	}
	skipReturns struct {
		result1 string
	}
...
func (fake *TaskCreationFilter) Skip(arg1 filter.Candidate) string {
	fake.skipMutex.Lock()
...
func (fake *TaskCreationFilter) SkipCalls(stub func(filter.Candidate) string) {
	fake.skipMutex.Lock()
	defer fake.skipMutex.Unlock()
	fake.SkipStub = stub
}

func (fake *TaskCreationFilter) SkipArgsForCall(i int) filter.Candidate {
	fake.skipMutex.RLock()
	defer fake.skipMutex.RUnlock()
