...
func (fake *TriggerHandler) ServeHTTP(arg1 context.Context, arg2 http.ResponseWriter, arg3 *http.Request) error {
...
func (fake *TriggerHandler) ServeHTTPCallCount() int {
	fake.serveHTTPMutex.RLock()
	defer fake.serveHTTPMutex.RUnlock()
	return len(fake.serveHTTPArgsForCall)
}

func (fake *TriggerHandler) ServeHTTPCalls(stub func(context.Context, http.ResponseWriter, *http.Request) error) {
	fake.serveHTTPMutex.Lock()
	defer fake.serveHTTPMutex.Unlock()
	fake.ServeHTTPStub = stub
}

func (fake *TriggerHandler) ServeHTTPArgsForCall(i int) (context.Context, http.ResponseWriter, *http.Request) {
	fake.serveHTTPMutex.RLock()
	defer fake.serveHTTPMutex.RUnlock()
...
func (fake *TriggerHandler) ServeHTTPReturns(result1 error) {
	fake.serveHTTPMutex.Lock()
	defer fake.serveHTTPMutex.Unlock()
...
func (fake *TriggerHandler) ServeHTTPReturnsOnCall(i int, result1 error) {
	fake.serveHTTPMutex.Lock()
	defer fake.serveHTTPMutex.Unlock()
	fake.ServeHTTPStub = nil
...
func (fake *TriggerHandler) Invocations() map[string][][]interface{} {
...
func (fake *TriggerHandler) recordInvocation(key string, args []interface{}) {
...
var _ handler.TriggerHandler = new(TriggerHandler)
